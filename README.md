...
This project is to continue the community driven build of W3 Total Cache (W3TC) maintained by [szepeviktor](https://github.com/szepeviktor) and originally developed by [ftownes](https://github.com/ftownes).  The aim is to ~~continuously incorporate fixes, improvements, and enhancements over the official Wordpress release of [W3 Total Cache]~~ keep this working build alive with minimal updates.
